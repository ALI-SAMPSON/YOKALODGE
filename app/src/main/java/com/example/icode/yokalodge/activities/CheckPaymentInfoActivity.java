...
public class CheckPaymentInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_payment_info);

        //getting reference to the toolbar
        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("CHECK PAYMENTS");
       ...
       /* paymentdB = FirebaseDatabase.getInstance();
        paymentRef = paymentdB.getReference().child("Payments");
        */
    ...
    public void populatePayments(){
        ...
        firebaseListAdapter = new FirebaseListAdapter(options) {
            ...
            protected void populateView(View v, Object model, int position) {
                ...
                room_number.setText(" Payment: " + payments.getRoom_number().toString());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.about_us:
                startActivity(new Intent(CheckPaymentInfoActivity.this,AboutUsAdminActivity.class));
                break;
                //navigates to the AdminDashboard activity
            case android.R.id.home:
                startActivity(new Intent(CheckPaymentInfoActivity.this,AdminDashBoardActivity.class));
                break;
                default:
                    break;
        }
